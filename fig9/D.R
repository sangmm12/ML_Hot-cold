setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_gene_hallmark")
...
pdf(paste("cor_gene_hallmark.pdf",sep=''),width =12,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
...
pdf(paste("cor_gene_hallmark_hot_low.pdf",sep=''),width =12,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_gene_hallmark_cold_high.pdf",sep=''),width =12,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
#######################################################
setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_gene_hallmark/10")
...
# data.r <- fread(paste("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_gene_hallmark/data.r_all.csv",sep=''))
# data.r <- as.data.frame(data.r)
# rownames(data.r) <- data.r[,1]
# data.r <- data.r[,-1]
data.r <- data.r[,1:10]

# data.p <- fread(paste("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_gene_hallmark/data.p_all.csv",sep=''))
# data.p <- as.data.frame(data.p)
# rownames(data.p) <- data.p[,1]
# data.p <- data.p[,-1]
data.p <- data.p[,1:10]
#data.p[] <- lapply(data.p, as.numeric)
...
pdf(paste("cor_gene_hallmark.pdf",sep=''),width =4,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_gene_hallmark_hot_low.pdf",sep=''),width =4,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_gene_hallmark_cold_high.pdf",sep=''),width =4,height = 24)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
