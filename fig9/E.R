setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_cell_hallmark")
...
pdf(paste("cor_cell_hallmark.pdf",sep=''),width =12,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
...
pdf(paste("cor_cell_hallmark_hot_low.pdf",sep=''),width =12,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_cell_hallmark_cold_high.pdf",sep=''),width =12,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
#################################################
setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/GSVA_hallmark/cor_cell_hallmark/10")
...
pdf(paste("cor_cell_hallmark.pdf",sep=''),width =5,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_cell_hallmark_hot_low.pdf",sep=''),width =5,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_cell_hallmark_cold_high.pdf",sep=''),width =5,height = 7)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
