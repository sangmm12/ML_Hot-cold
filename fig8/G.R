setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/down/cor_estimate")
...
pdf(paste("cor_genedown_ESTIMATE.pdf",sep=''),width =2.6,height = 20)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
...
pdf(paste("cor_genedown_hot_low_ESTIMATE.pdf",sep=''),width =2.6,height = 20)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_genedown_cold_high_ESTIMATE.pdf",sep=''),width =2.6,height = 20)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
