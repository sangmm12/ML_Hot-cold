setwd("D:/R/ML_PAAD/data1/AUCAtcga/DEGs&WGCNA/TPM_0.3_0.01_1_sec/0.6_0.2/drug/drugCTRP2_2/DEGs_downRMA/zong/cor_cell")
...
myBreaks <- c(seq(-0.5, 0, length.out=ceiling(paletteLength/2) + 1),
              seq(0.5/paletteLength, 0.5, length.out=floor(paletteLength/2)))


#chr [1:6, 1:5] "*" "***" "" "***" "***" "***" "***" "" "***" "**" ...

pdf(paste("cor_drug_cell.pdf",sep=''),width =10,height = 9)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
...
pdf(paste("cor_drug_cell_hot_low.pdf",sep=''),width =10,height = 9)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
...
pdf(paste("cor_drug_cell_cold_high.pdf",sep=''),width =10,height = 9)
pheatmap(data.r, 
         color=myColor,
         breaks=myBreaks,
         clustering_method="average", cluster_rows=F, cluster_cols=F,display_numbers=sig.mat
